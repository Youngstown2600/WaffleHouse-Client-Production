...
public:
          ...
          m_original(defaults)
    {
        ...
        m_sipCompatibilityLabel = new QLabel(QStringLiteral("Server compatibility:"), this);
        m_sipCompatibility = new QComboBox(this);
        m_sipCompatibility->addItems({QStringLiteral("auto"), QStringLiteral("standard"), QStringLiteral("asterisk-chan_sip")});
        m_sipCompatibility->setCurrentText(defaults.sipCompatibility.isEmpty() ? QStringLiteral("auto") : defaults.sipCompatibility.toCaseFolded());
        m_sipCompatibility->setToolTip(QStringLiteral("Use asterisk-chan_sip for legacy Asterisk chan_sip peers/registrars. WaffleHouse still uses PJSIP internally."));
    ...
    ConnectionSettings settings() const
    {
        ...
        value.sipCompatibility = m_sipCompatibility->currentText();
