# WaffleHouse-Client 5.0r10 — Media Center
...
The dedicated YouTube streaming/audio feature is intentionally absent from WaffleHouse-Client 5.0r10. The GUI button and Media-menu action are removed, `/myoutube` is absent from the CLI, yt-dlp/Deno resolver dependencies are removed, and mpv starts with `--ytdl=no`.
