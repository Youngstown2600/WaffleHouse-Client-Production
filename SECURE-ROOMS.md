...
WaffleHouse-Client 3.4r1 uses a compact main **Accounts** window without the old navigation rail. SIP accounts remain visible alongside AIM/IRC/Telnet accounts. The full Softphone workspace is available from **Tools -> Open Softphone**, the system tray, and supported `/phone` commands.
