    ...
    : QWidget(parent), m_controller(controller)
{
    ...
    m_compatibility->addItems({QStringLiteral("auto"), QStringLiteral("standard"), QStringLiteral("asterisk-chan_sip")});
    m_compatibility->setToolTip(QStringLiteral("Legacy Asterisk chan_sip mode disables SIP-Outbound and uses legacy-safe Contact rewriting."));
    ...
    form->addRow(QStringLiteral("Server compatibility:"), m_compatibility);
