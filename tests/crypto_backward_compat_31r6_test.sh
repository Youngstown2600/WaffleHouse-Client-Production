...
fail(){ echo "Media Center 3.3 crypto compatibility regression failed: $*" >&2; exit 1; }
...
# The Media Center is a media/rebrand delta and must not alter established encryption/transfer wire code.
...
echo 'WaffleHouse-Client 3.3r1 encrypted DM/file-transfer/Secure Room wire compatibility: PASS'
